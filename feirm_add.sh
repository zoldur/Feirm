...
ORIGFOLDER='/root/.feirmdefault'
CONFIGFOLDER="/root/.feirm-$1"
COIN_DAEMON='feirmd'
COIN_CLI='feirm-cli'
...
function ask_port() {
DEFAULT_COIN_PORT=4918
read -p "Feirm Port: " -i $DEFAULT_COIN_PORT -e COIN_PORT
...
/usr/local/bin/feirm-cli -conf=$CONFIGFOLDER/$CONFIG_FILE -datadir=$CONFIGFOLDER \$@
EOF
